...
export default function StoreFooter() {
  ...
  return (
    <footer dir={dir} className="store-footer" style={{ background: '#1a1a1a', color: '#aaa', padding: '50px 0 20px' }}>
      <div className="store-footer-container" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 30px' }}>
        <div className="store-footer-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '40px', marginBottom: '40px' }}>
          {/* About */}
